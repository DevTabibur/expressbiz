  ...
  return (
    <div className="mt-0">
      <div
        ...
        className="carousel slide carousel-fade carousel-dark relative custom-css h-64 shadow-2xl"
      ...
      >
        ...
        {/* <!-- Controls --> */}
        <button
          className="carousel-control-prev hidden absolute top-0 bottom-0 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline left-0"
          type="button"
          data-bs-target="#carouselDarkVariant"
          data-bs-slide="prev"
        >
        ...
        <button
          className="carousel-control-next hidden absolute top-0 bottom-0 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline right-0"
          type="button"
          data-bs-target="#carouselDarkVariant"
          data-bs-slide="next"
        >
